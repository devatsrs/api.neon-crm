			...
			{				
				...
				{   
					...
					{   
						...
						$TicketData['Priority']			=	$FreshDeskObj->SetPriority($GetTickets_data->priority);
						$TicketData['Status']			=	$FreshDeskObj->SetStatus($GetTickets_data->status);
						$TicketData['Type']				=	$GetTickets_data->type;				
						$TicketData['Group']			=	$FreshDeskObj->SetGroup($GetTickets_data->group_id);
